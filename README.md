...
```
go get github.com/ElvinEga/go-openai
```
...
See also: https://pkg.go.dev/github.com/ElvinEga/go-openai#ClientConfig
</details>
...
import (
	...
	"github.com/ElvinEga/go-openai"
	"github.com/ElvinEga/go-openai/jsonschema"
)
...
**Related Issues:**
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/ElvinEga/go-openai/issues/9)
...
**Related Issues:**
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/ElvinEga/go-openai/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/ElvinEga/go-openai/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/ElvinEga/go-openai/graphs/contributors) and sponsors of this project:
